...
#SBATCH --gres=gpu:0 
#SBATCH --output=server_logs/scripts_bipedal_upper_run_training 
#SBATCH --error=server_logs/scripts_bipedal_upper_run_training_error
