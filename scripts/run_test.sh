...
q_bound_type='constrained_optimal_tight' #'constrained_lower_upper' 'nstep_lower' 'nstep_lower_upper', nstep_lower_interaction_upper, bellman_lower_upper
DEMO_DIR='demo/'
...
random_seed=0
store_path="tmp/test/constrained_by_${q_bound_type}/${env}_subsampling_${subsampling}_numdemo_${num_demonstrations}_random_"
