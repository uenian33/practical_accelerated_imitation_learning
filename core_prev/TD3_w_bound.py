    ...
    def train(self, gradient_steps: int, batch_size: int = 100, update_actor=True, weight_factor=0, use_expert_Q=False) -> None:
        ...
        for gradient_step in range(gradient_steps):
            ...
            with th.no_grad():
                ...
                w_target_q = w_replay_data.rewards + (1 - w_replay_data.dones) * self.gamma * next_target_q
            ...
            critic_bound_loss = sum([F.mse_loss(current_q, w_target_q) for current_q in current_q_estimates])
